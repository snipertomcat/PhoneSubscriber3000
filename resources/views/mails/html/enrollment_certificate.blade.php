        ...
        <tr style="border-collapse:collapse;">
            <td align="center" style="padding:0;Margin:0;">
                <table bgcolor="transparent" class="es-content-body" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="left"
                            style="Margin:0;padding-top:20px;padding-bottom:0px;padding-left:20px;padding-right:20px;background-position:center top;background-color:#FFFFFF;border-left:1px solid lightgray;border-right:1px solid lightgray;border-top:1px solid lightgray;"
                            bgcolor="#ffffff">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="left" style="padding:0;Margin:0;">
                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">
                                                        Felicidades por haber completado exitosamente tu curso.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td class="es-m-p20b" width="560" align="left"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" bgcolor="transparent"
                                            ...
                                            <tr style="border-collapse:collapse;padding-bottom:20px;">
                                                <td align="left"
                                                    style="padding:0;Margin:0;padding-top:15px;padding-left:15px;padding-right:15px;">
                                                    <h3 style="text-align:center;margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;">
                                                        {{ $experience->title }}
                                                    </h3>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td align="left" style="padding:0;Margin:0;">
                                                    <p style="text-align:center;margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">
                                                        Ya pudes descargar tu certificado.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr style="border-collapse:collapse;">
