...
@section('body')
    ...
    {label:'Invitar', route_name:'invitations.index'},{label:'Usuarios Evento', route_name:'demo.invitations'}
    ]"></apithy-owner-tabs-menu>
    @endif
    <div class="container">
        <apithy-demo-invitations :roles="{{ $roles }}"
                                  :companies="{{ $companies }}"
                                  :auth-user="{{ $auth_user }}"
                                  v-cloak>
        </apithy-demo-invitations>
    </div>
