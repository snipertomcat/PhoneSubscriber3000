...
<head>
    ...
    <title>Copy of Apithy Invoice</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
...
@php
// Logo de la empresa, solo si se esta en el dominio de está
if (!isset($logo)) {
...
<div class="es-wrapper-color" style="background-color:transparent;">
    ...
    <table cellpadding="0" cellspacing="0" class="es-wrapper" width="100%"
           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:no-repeat;background-position:center top;background-image:url({{asset('images/mails/bg.png')}});background-size:cover;"
           background="{{asset('images/mails/46351545686878596.png')}}">
        <tr style="border-collapse:collapse;">
            <td valign="top" style="padding:10px;Margin:0;" bgcolor="transparent">
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-header-body" align="center" cellpadding="0" cellspacing="0" width="600"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td align="left"
                                        style="padding:0;Margin:0;padding-bottom:20px;padding-right:20px;background-position:center top;">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left" style="padding:0;Margin:0;"><a
                                                                        href="http://www.apithy.com" target="_blank"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;text-decoration:underline;color:#1376C8;"><img
                                                                            src="{{$logo}}" alt=""
                                                                            width="124"
