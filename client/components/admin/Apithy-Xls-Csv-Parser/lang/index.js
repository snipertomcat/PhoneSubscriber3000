export default {
    ...
    es: {
        ...
        select: 'Selecciona',
        selectColumn: 'Ninguno',
        file: {
            select: 'Por favor escoje una archivo',
            tryAgain: 'Agregar otro',
            withHeaders: 'Este archivo incluye encabezados',
            withoutHeaders: 'Este archivo no incluye encabezados',
        },
        error: {
            title: 'Error',
            columnNumber: 'No tienes suficientes columns. <br><b>Las columnas obligatorias son</b>: ',
            missingColumns: 'Faltan columnas obligatorias:',
            selectColumn: 'Necesitas seleccionar todas las columnas',
            fileNumber: 'Necesitas seleccionar un archivo',
            fileSelection: 'No se ha seleccionado un archivo',
            invalidFile: 'Archivo invalido. Intenta usar un XLS o CSV',
            noWorksheet: 'Debe tener al menos una pagina',
            emptyWorksheet: 'La pagina esta vacia',
        },
    },
};