                ...
                <div class="card-content">
                    <div class="row">
                        <div class="col-12 has-text-centered">
                            ...
                            {{ $t('messages.create_new') }} {{ $t('messages.ability') }}
                        </span>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea type="text" class="input width-100 height-100" v-model="form.description"></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
