                ...
                <div class="card-content">
                    <div class="row">
                        <div class="col-12 has-text-centered">
                            ...
                            {{ $t('messages.edit') }} {{ $t('messages.ability') }}
                        </span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" class="input width-100" placeholder="Nombre" v-model="ability.title">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <label>{{ $t('messages.description') }}</label>
                            <textarea type="text" class="input width-100 height-100" v-model="ability.description"></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
        ...
        methods: {
            ...
            update() {
                this.$snotify.async(this.$t('messages.ability'), 'Procesando', () => new Promise((resolve, reject) => {
                    return axios({
                        method: 'PUT',
                        url: route('abilities.update',[this.id]),
                        params: this.ability,
                    }).then((response) => {
                        // Do somethings
