            ...
            <div class="card-content">
                ...
                <div class="row font-14">
                    <div class="col-12 col-lg-4">
                        ...
                        <b-input icon-pack="fas" icon="sitemap" placeholder="Escribe un nombre" v-model="form.name" :disabled="!editing"></b-input>
                    </div>
                    <div class="col-12 col-lg-4">
                        <label class="has-text-weight-bold">Nombre corto</label>
                        <b-input icon-pack="fas" icon="sitemap" placeholder="Escribe un nombre corto" v-model="form.short_name" :disabled="!editing"></b-input>
                    </div>
                    <div class="col-12 col-lg-4">
                ...
                this.$validator.validateAll().then(result => {
                    if (result) {
                        this.$snotify.async('Área', 'Procesando', () => new Promise((resolve, reject) => {
                            return axios({
                                method: 'PUT',
                                url: route('areas.update',[this.form.company_id, this.form.id]),
                                params: this.form,
                            }).then((response) => {
                                this.editing = false;
