<template>
  <div id="register-form" class="container">
    <div>
      <div class="row register" v-if="register_type.show&&false"> // Remover el false
      ...
      <div class="row register-form mt-5" v-if="register_form.show">
        <div class="col-12 col-md-3 text-center pt-2">
          <div class="row">
            <figure class="image image-center pointer profile-avatar image-company">
              <img :src="company.full_path_logo" alt="" class="image image-responsive">
            </figure>
            <!--
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 col-md-6 apithy-with-icon">
                      <div class="input-group">
                        ...
                        <input
                            ...
                            v-validate="confirmEmailRules">
                      </div>
                      <span class="text-danger"
                            v-show="errors.has('confirm_email')">{{ errors.first('confirm_email') }}</span>
                    </div>
                  </div>
                  <br>
                  <div class="row justify-content-md-left" v-if="register_form.form_data.contact_preferences !== 'sms'">
                    ...
                    <div class="col-12 col-md-6 apithy-with-icon">
                      ...
                      <span class="text-danger"
                            v-show="errors.has('confirm_phone')">{{ errors.first('confirm_phone') }}</span>
                    </div>
                  </div>
          ...
          <div class="" v-if="wrong.phone">
            <div class="row justify-content-center">
              <div class="col-8 apithy-with-icon">
                <div class="input-group">
                                    <span
                                        :class="{'input-group-addon icon':true, 'text-danger': errors.has('new_phone')}">
                                        <i class="fas fa-phone"></i>
                                    </span>
                  <input type="text"
                         ref="new_phone"
            ...
            <div class="row justify-content-center">
              <div class="col-8 apithy-with-icon">
                <div class="input-group">
                                    <span
                                        :class="{'input-group-addon icon':true, 'text-danger': errors.has('confirm_new_phone')}">
                                        <i class="fas fa-phone"></i>
                                    </span>
                  <input type="text"
          ...
          <div class="" v-else>
            <div class="row justify-content-center">
              <div class="col-8 apithy-with-icon">
                <div class="input-group">
                                    <span
                                        :class="{'input-group-text icon':true,'text-danger': errors.has('new_email')}">
                                        <i class="fas fa-envelope"></i>
                                    </span>
                  <input type="email"
                         name="new_email"
          ...
          <div class="row justify-content-center mt-3" v-if="register_welcome.message">
            <div class="col-6">
              <div class="alert alert-danger" role="alert">
                <button type="button" class="close" @click="register_welcome.message = null" aria-label="Close"><span
  ...
  export default {
    ...
    computed: {
      emailRules () {
        ...
        if (this.register_form.form_data.contact_preferences == 'sms') {
          rules_email.required = false;
        }
