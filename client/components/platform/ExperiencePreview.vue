    ...
    <div class="experience-preview-component">
        ...
        <div class="mobile-actions action-buttons d-block d-md-none d-lg-none hidden" v-sticky>
            <div class="row justify-content-center">
                <!--
                <div class="col-6 text-center" v-if="!is_purchased && !isUserEnrolled">
                    <button class="btn pointer" @click="goToExperience"><i class="fab fa-leanpub" v-if="false"></i> <b>Probar</b></button>
                </div>
                -->
                <div class="col-6 text-center" v-if="!is_purchased && !is_cart_added && experience.price > 0 ">
                    <button class="btn pointer" @click="purchase"><i class="fa fa-shopping-cart" v-if="false"></i> <b>Añadir al carrito</b></button>
                </div>
                <div class="col-6 text-center" v-if="isUserEnrolled">
                    <button class="btn pointer" @click="goToExperience"><i class="fa fa-play-circle" v-if="false"></i> <b>Continuar</b></button>
                </div>
                <div class="col-6 text-center" v-if="!isUserEnrolled && (is_purchased | experience.price == 0)">
                    <button class="btn pointer" @click="enroll"><i class="fa fa-play-circle" v-if="false"></i> <b>Comenzar</b></button>
                </div>
            </div>
        </div>
        <div class="content-container">
            <div class="row mr-0 ml-0">
                <div class="col-sm-3 d-none d-md-block mt-4">
                    ...
                    <div class="action-buttons">
                        <div class="row justify-content-center">
                            <!--
                            <div class="col-8 text-center" v-if="!is_purchased && !isUserEnrolled">
                                <button class="btn pointer" @click="goToExperience"><i class="fa fa-leanpub" v-if="false"></i> <b>Probar</b></button>
                            </div>
                            -->
                            <div class="col-8 text-center" v-if="!is_purchased && !is_cart_added && experience.price > 0" @click="purchase">
                                <button class="btn pointer"><i class="fa fa-shopping-cart" v-if="false"></i> <b>Añadir al carrito</b></button>
                            </div>
                            <div class="col-8 text-center" v-if="isUserEnrolled" @click="goToExperience">
                                <button class="btn pointer"><i class="fa fa-play-circle" v-if="false"></i> <b>Continuar</b></button>
                            </div>
                            <div class="col-8 text-center" v-if="!isUserEnrolled && (is_purchased || experience.price == 0)" @click="enroll">
                                <button class="btn pointer"><i class="fa fa-leanpub" v-if="false"></i> <b>Comenzar</b></button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" v-if="is_experience">
                <div class="col-md-3 experience-summary-content d-none d-md-block mt-3" ref="adventure_content"
                    ...
                    <ul class="row adventure-content">
                        ...
                        <li class="col-sm-12" v-if="num_content_downloads"><i
                                class="padding-r5 fas fa-cloud-download-alt"></i> {{ num_content_downloads }} archivos
                            para descargar
                        </li>
                        ...
                        <li class="col-sm-12" v-if="(experience.type === 'journey' && experience_has_adventures)"><i
                                class="padding-r5 fas fa-trophy"></i> {{ experience_has_adventures }} experiencias
                        </li>
                        <li class="col-sm-12" v-if="false && (experience.type === 'adventure' && experience_has_sessions)"><i
                                class="padding-r5 fas fa-trophy"></i> {{ experience_has_sessions }} retos
                        </li>
                ...
                <div :class="{'col-12 col-lg-9':true, 'offset-lg-3':!has_instructors}">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-12 col-sm-5 made-by mt-5" v-if="experience.company_author">
                                ...
                                <div class="d-none d-md-block">
                                    <div class="row">
                                        ...
                                        <div class="col align-self-end no-pl align-self-center">
                                            <span class=""><b>{{ experience.company_author.name }}</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 instructors mt-5" :class="{'col-sm-7':!many_instructors}" v-if="has_instructors">
                            ...
                            <div class="col-12 col-sm-7 mt-5" v-else>
                                <p class="padding-b10" v-if="has_features"><b>Esta experiencia tiene:</b></p>
                                <ul class="row adventure-content">
                                    ...
                                    <li class="col-sm-12" v-if="num_content_downloads"><i
                                            class="pr-3 fas fa-cloud-download-alt"></i> {{ num_content_downloads }}
                                        archivo{{ (num_content_downloads > 1) ? 's' : '' }} para descargar
                                    </li>
                                    <li class="col-sm-12" v-if="num_activities"><i class="pr-3 fas fa-basketball-ball"></i>
                                        {{ num_activities }} actividad{{ (num_activities > 1) ? 'es' : '' }}
                                    </li>
                                    <li class="col-sm-12"
                                        v-if="(experience.type === 'journey' && experience_has_adventures)"><i
                                            class="pr-3 fas fa-trophy"></i> {{ experience_has_adventures }}
                                        experiencia{{ (experience_has_adventures > 1) ? 's' : '' }}
                                    </li>
                                    <li class="col-sm-12" v-if="false && (experience.type === 'adventure' && experience_has_sessions)"><i
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 order-1 order-md-0">
                            ...
                            <ul class="row adventure-content">
                                ...
                                <li class="col-sm-12" v-if="num_content_downloads"><i
                                        class="padding-r5 fas fa-cloud-download-alt"></i> {{ num_content_downloads }}
                                    archivo{{ (num_content_downloads > 1) ? 's' : '' }} para descargar
                                </li>
                                <li class="col-sm-12" v-if="num_activities"><i class="padding-r5 fas fa-basketball-ball"></i> {{ num_activities }}
                                    actividad{{ (num_activities > 1) ? 'es' : '' }}
                                </li>
                                <li class="col-sm-12" v-if="(experience.type === 'journey' && experience_has_adventures)"><i
            ...
            <div class="experience-info-gallery">
                ...
                <apithy-session-gallery v-if="experience_has_sessions"
                                        title="El reto de hoy"
                                        :video_teaser="experience.video_teaser"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            enlarge_instructors_list: function () {
                let enlargue_instructors_list = [];
                let first_autor = null;
                let second_autor = null;

                _.each(this.experience.instructors, (instructor, key) => {
                    if (key % 2) {
                        second_autor = instructor;
                    } else {
                        first_autor = instructor
                    }
                    if (!!second_autor) {
                        enlargue_instructors_list.push([first_autor,second_autor]);
                        first_autor = null;
                        second_autor = null;
                    }
                })
                return enlargue_instructors_list;
            },
            many_instructors: function () {
                return (this.experience_data.instructors.length > 2);
            },
            ...
            num_videos: function () {
                return (this.experience_data.features && this.experience_data.features.num_videos > 0) ? this.experience_data.features.num_videos : 0;
            },
            num_content_downloads: function () {
                return (this.experience_data.features && this.experience_data.features.num_content_downloads > 0) ? this.experience_data.features.num_content_downloads : 0;
            },
            num_activities: function () {
                return (this.experience_data.features && this.experience_data.features.num_activities > 0) ? this.experience_data.features.num_activities : 0;
            },
            experience_has_sessions: function () {
                return (this.experience_data.sessions && this.experience_data.sessions.length > 0) ? this.experience_data.sessions.length : 0;
            },
            experience_has_adventures: function () {
                return (this.experience_data.adventures && this.experience_data.adventures.length > 0) ? this.experience_data.adventures.length : 0;
            },
            ...
            isUserEnrolled: function () {
                if (this.experience_data.current_user_enrollment) {
                    return true;
                }
            },
        ...
        mounted() {
            ...
            if (!_.isEmpty(operation_result) && !!operation_result[this.experience.id]) {
        ...
        methods: {
            ...
            goToExperience() {
                ...
                let url = origin + path + this.experience.system_id + '/view';

                if (this.isUserEnrolled) {
                    url = url + '/' + this.experience_data.current_user_enrollment.id;
                }
            ...
            goToPaymentSources() {
                let origin = window.location.origin;
                let path = '/profile/payment-information';
                let url = origin + path;
            ...
            purchase() {
                if (this.auth_user.is_admin && !this.show_modal) {
                    this.openModal();
                } else {
                    axios({
                        method: 'POST',
            ...
            enroll() {
                ...
                this.$snotify.async('Enrolamiento', 'Procesando enrolamiento', () => new Promise((resolve, reject) => {
                    return axios({
                        ...
                        this.experience_data.current_user_enrollment = response.data.data;
                        setTimeout(() => this.goToExperience(), 1000)
