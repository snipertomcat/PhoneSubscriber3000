...
class WebhookController extends Controller
{
    ...
    {
        try {
            Conekta::setApiKey(Config::get('services.payments.secret'));
     ...
     *
     * @return \Apithy\Payments\Conekta\BillableInterface
     */
    protected function getBillable($conektaId)
    {
        return App::make('Apithy\Payments\Conekta\BillableRepositoryInterface')->find($conektaId);
    }
