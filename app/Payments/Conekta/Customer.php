...
use Conekta\Customer as Conekta_Customer;
...
class Customer extends Conekta_Customer
{
     ...
     * @return void
     */
    protected function generateSubscription(array $params)
    {
    ...
    public function updateSubscription($params = null)
    {
        if (is_null($this->subscription) || $this->subscription->status == 'canceled') {
            return $this->generateSubscription($params);
        }

        return $this->updateSubscriptionData($params);
    }
     ...
     * @return void
     */
    public function updateSubscriptionData($params = null)
    {
